...
- Physical data: weight, temperature, sleep hours, water intake
- Medicines and supplements you choose to log
- Name and date of birth (both optional, used only for personalisation)
- Health goal selection

**We do NOT collect:** location data, contacts, camera or microphone access, or any data beyond what you explicitly enter in the app.
...
- Display your cycle predictions and calendar
- Generate personalised tips and cycle insights
- Create PDF health reports stored locally on your device
- Send reminders you have enabled

Your data is never used for advertising, profiling, or any purpose other than providing the app features to you.
...
**Settings → Backup & Restore → Delete All Data**

This permanently removes all logs and notes from your device.
...
We may update this privacy policy from time to time. The latest version will always be available within the app under Settings → About → Privacy Policy, and at this URL.
